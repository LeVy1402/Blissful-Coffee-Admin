...
<%--                </li>--%>
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="mm-collapse">
                        ...
                        <li><a href="/staffs">Add New Staff</a></li>
                    </ul>
                </li>
                <li>
                    <a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="form-head d-flex mb-3 align-items-center justify-content-between">
                ...
                <div class="col-3">
                    <form method="get" action="/customers" style="margin-bottom: 0px;">
...
<%--                <div class="">--%>
<%--                    <div class="dropdown custom-dropdown" style="margin-bottom: 0px;">--%>
...
<%--                                    <td><c:out value="${customerLists.get(customer.getFullName())}"></c:out></td>--%>
                                  <td>10vnd</td>
