            ...
            <ul class="metismenu mm-show" id="menu">
                ...
                <li class="mm-active"><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false" class="mm-collapse mm-show">
                        <li class="mm-active">
                            <a href="./app-profile.html" class="mm-active">Order List</a>
                        </li>
    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="form-head d-flex mb-3 align-items-center justify-content-between">
                ...
                <div class="col-6">
                    <button type="button" class="btn btn-primary d-flex align-items-center svg-btn" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fa fa-plus scale5 ms-3"></i>
                        <span class="fs-16 ms-3">Add New Order</span>
                    </button>
                </div>
                <div class="">
                    ...
                    <div class="table-responsive">
                        <table id="example5" class="display mb-4 dataTablesCard" style="min-width: 845px;">
                            ...
                            <tr>
                                ...
                                <td>$24.17</td>
                                <td><span class="btn btn-sm light btn-warning w-space-no w-space-no">New Order</span>
                                </td>
                                <td>
                                    <div class="dropdown ms-auto text-right">
                                        <div class="btn-link" data-bs-toggle="dropdown">
                            ...
                            <tr>
                                ...
                                <td>$74.92</td>
                                <td><span class="btn btn-sm light btn-primary w-space-no w-space-no">On Delivery</span>
                                </td>
                                <td>
                                    <div class="dropdown ms-auto text-right">
                                        <div class="btn-link" data-bs-toggle="dropdown">
                            ...
                            <tr>
                                ...
                                <td>$22.18</td>
                                <td><span class="btn btn-sm light btn-warning w-space-no">New Order</span></td>
                                <td>
                                    <div class="dropdown ms-auto text-right">
                                        <div class="btn-link" data-bs-toggle="dropdown">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <tr>
                                <td>#4546563</td>
                                <td class="w-space-no">26 March 2020, 12:42 AM</td>
                                <td class="w-space-no">Roberto Carlo</td>
                                <td class="w-space-no">Roberto Carlo</td>
                                <td>$34.41</td>
                                <td><span class="btn btn-sm light btn-warning w-space-no">New Order</span></td>
                                <td>
