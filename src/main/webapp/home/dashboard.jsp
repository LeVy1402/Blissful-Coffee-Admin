        ...
        <div class="container-fluid">
            <div class="form-head d-flex mb-3 align-items-start">
                <div class="me-auto d-none d-lg-block">
                    ...
                    <p class="mb-0">Welcome to Nhân!</p>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-9 col-lg-10 col-xxl-8 col-sm-9 col-md-9">
                                            <div class="d-flex align-items-center mb-3">
                                                <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">On delivery (64%)</p>
                                                <div class="progress mb-0" style="height:8px; width:100%;">
                                                    <div class="progress-bar bg-warning progress-animated"
                                                         style="width:64%; height:8px;" role="progressbar">
                                            ...
                                            <div class="d-flex align-items-center  mb-3">
                                                <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Delivered (21%)</p>
                                                <div class="progress mb-0" style="height:8px; width:100%;">
                                                    <div class="progress-bar bg-success progress-animated"
                                                         style="width:21%; height:8px;" role="progressbar">
                                                        <span class="sr-only">60% Complete</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <p class="mb-0 fs-14 me-2 col-4 col-xxl-5 px-0">Canceled (15%)</p>
                                                <div class="progress mb-0" style="height:8px; width:100%;">
                                                    <div class="progress-bar bg-dark progress-animated"
                                                         style="width:15%; height:8px;" role="progressbar">
                                                        <span class="sr-only">60% Complete</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="card-body revenue-chart px-3">
                            <div class="d-flex flex-wrap justify-content-end pe-3 pull-right revenue-chart-bar">
                                <div class="d-flex align-items-end me-4 mb-2">
                                    <img src="/template/images/svg/ic_stat2.svg" height="22" width="22" class="me-2 mb-1"
                                         alt=""/>
                                    <div>
                                ...
                                <div class="d-flex align-items-end mb-2">
                                    <img src="/template/images/svg/ic_stat1.svg" height="22" width="22" class="me-2 mb-1"
                                         alt=""/>
                                    <div>
